...
-- tick (~1 Hz). Never updated, never deleted, no preprocessing applied — this
-- is "what the sensor actually said". physicsValid/physicsViolations are the
-- ONE exception: they are added by Node-RED immediately after generation
-- (before storage) as an annotation, not a modification — the six telemetry
...
CREATE TABLE IF NOT EXISTS raw_telemetry (
  ...
  isSynthetic        INTEGER NOT NULL DEFAULT 1,   -- 1 = generated by the Virtual Estimator
