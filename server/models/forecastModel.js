...
// raw 1 Hz stream. processedModel.js already owns the query for that
// (getRecentProcessed), so this file delegates to it instead of duplicating
// a second "SELECT * ... ORDER BY id DESC LIMIT $1" against the same table.
// The getRecentReadings name is kept so forecastService.js and
...
export async function getRecentReadings(n) {
